...
public class CommentManager extends FirebaseListenersManager {
    ...
    public void createOrUpdateComment(String userId, String commentText, String postId, OnTaskCompleteListener onTaskCompleteListener) {
        ApplicationHelper.getDatabaseHelper().createComment(userId,commentText, postId, onTaskCompleteListener);
    }
