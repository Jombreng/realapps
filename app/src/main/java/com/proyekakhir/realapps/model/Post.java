...
public class Post implements Serializable, LazyLoading {
    ...
    private boolean state360;
    private boolean statePrivate;
    private boolean stateVideo360;

    public void setStateVideo360(boolean stateVideo360) {
        this.stateVideo360 = stateVideo360;
    }

    public boolean isStateVideo360() {

        return stateVideo360;
    }

    public void setState360(boolean state360) {
        this.state360 = state360;
    }

    public void setStatePrivate(boolean statePrivate) {
        this.statePrivate = statePrivate;
    }

    public boolean isState360() {
        return state360;
    }

    public boolean isStatePrivate() {
        return statePrivate;
    }
    ...
    public Map<String, Object> toMap() {
        ...
        result.put("state360", state360);
        result.put("statePrivate", statePrivate);
        result.put("stateVideo360",stateVideo360);
        return result;
    }
