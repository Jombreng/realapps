...
import com.proyekakhir.realapps.activities.PrivatePostActivity;
import com.proyekakhir.realapps.activities.SearchActivity;
...
import com.proyekakhir.realapps.adapters.holders.PrivatePostViewHolder;
...
public class PostsAdapterPrivate extends BasePostsAdapter {
    public static final String TAG = PostsAdapterPrivate.class.getSimpleName();

    private boolean isFollowingFeed = false;
    private Callback callback;
    private boolean isLoading = false;
    private boolean isMoreDataAvailable = true;
    private long lastLoadedItemCreatedDate;
    private SwipeRefreshLayout swipeContainer;
    private PrivatePostActivity mainActivity;
    private ArrayList<String> followingIds;

    public PostsAdapterPrivate(final PrivatePostActivity activity, SwipeRefreshLayout swipeContainer) {
        super(activity);
    ...
    public PostsAdapterPrivate(final PrivatePostActivity activity, SwipeRefreshLayout swipeContainer, Boolean isFollowingFeed, ArrayList<String> followingIds) {
        super(activity);
        this.isFollowingFeed = isFollowingFeed;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == ItemType.ITEM.getTypeCode()) {
            return new PrivatePostViewHolder(inflater.inflate(R.layout.image_list_item, parent, false),
    ...
    private PrivatePostViewHolder.OnClickListener createOnClickListener() {
        return new PrivatePostViewHolder.OnClickListener() {
            @Override
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (getItemViewType(position) != ItemType.LOAD.getTypeCode()) {
            ((PrivatePostViewHolder) holder).bindData(postList.get(position));
        }
    }
    ...
    public void loadFirstPage() { loadNext(0);
    ...
    private void loadNext(final long nextItemCreatedDate) {
        ...
        PostManager.getInstance(activity).getPostsListPrivate(onPostsDataChangedListener, nextItemCreatedDate);
    }
