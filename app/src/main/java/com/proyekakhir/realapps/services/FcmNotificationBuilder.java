...
public class FcmNotificationBuilder {
    ...
    private static final String SERVER_API_KEY = "AAAAM0LES18:APA91bE05pmuLenrsDrFL0DUl_8d7HwL6sAO2I7Bxwnxq4LLq-Os5ZsOwXhBeQTvgkWLVHmJ8wv3TmMesPgj-MgVRiLRoZ5DcgOYFRauqW4HMObEmCZI_sSnMrR0ULxgbCcjyWuB7P_b";
    ...
    public void send() {
        ...
        try {
            ...
            Log.e(TAG, "send: "+getValidJsonBody().toString() );
    ...
    private JSONObject getValidJsonBody() throws JSONException {
        ...
        Log.e(TAG, "getValidJsonBody isi token: "+mFirebaseToken );
